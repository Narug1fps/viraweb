      ...
      <section id="sobre" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6  lg:px-8">
          <div className="text-center mb-12">
           ...
           O ponto de virada entre o mundo físico e o digital. Criamos caminhos, não apenas sites.
Transformamos presença física em presença digital — somos a ponte entre a ideia e a web.
            </p>
          </div>

          <div className="relative max-w-4xl mx-auto">
            <div
              className="aspect-video rounded-2xl overflow-hidden shadow-2xl bg-primary"
            >
          ...
          <button
    className="mt-6 px-50 py-3 bg-primary text-white font-semibold rounded-xl shadow-md hover:scale-110 transition-all duration-200 active:scale-95 cursor-pointer ">
    Orçamento
  </button>
          </div>
        </div>
